...
echo '<h1>Site2CRM Admin Panel for Hubspot <img clsss="site2crm-admin-menu-hubspot-logo" style="position:fixed; opacity:0.4; right:1vw; bottom:13vh;" alt="" src="'.$dir.'" ></img></h1></br>';
echo '<hr>';
echo '<h2>API Data</h2>';
